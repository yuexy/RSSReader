...
//					setChecked(true);
	...
	protected void setAttributes(AttributeSet attrs)
	{
		...
		// Set size of view
		setMinimumHeight((int) Utils.dpToPx(48, getResources()));
		setMinimumWidth((int) Utils.dpToPx(80, getResources()));
		...
		check = attrs.getAttributeBooleanValue(MATERIALWIDGETXML, "check", false);
		eventCheck = check;
		ball = new Ball(getContext());
		RelativeLayout.LayoutParams params = new LayoutParams((int) Utils.dpToPx(20, getResources()), (int) Utils.dpToPx(20, getResources()));
...
//		}
	...
	public void setCheckWithListener(boolean check)
	{
		this.check = check;
		ball.animateCheck();
