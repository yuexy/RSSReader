...
import zq.mdlib.contextmenu.interfaces.OnMenuItemClickListener;
import zq.mdlib.contextmenu.interfaces.OnMenuItemLongClickListener;

public class ContextMenuDialogFragment extends DialogFragment implements OnItemClickListener,
		OnItemLongClickListener
{
	...
	{
		mDropDownMenuAdapter = new MenuAdapter(getActivity(), mWrapperButtons, mWrapperText, mMenuParams.getMenuObjects(), mMenuParams.getActionBarSize());
